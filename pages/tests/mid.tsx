      ...
      {!gameStarted ? (
        <div className="text-center gap-5 flex flex-col mt-10">
          <h1 className="text-3xl font-bold">
            Welcome to the Mid-Evaluation Test!
          </h1>
          <h1>
        ...
        <div className="text-center mt-20">
          <h1 className="text-3xl w-1/2 text-center mx-auto font-bold">
            Congratulations on completing the mid-evaluation test. You will now
            complete a game called Attacker or Ally, and this serves as a more
            interactive form of training than the traditional written training.
          </h1>
