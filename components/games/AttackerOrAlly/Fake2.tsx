  ...
  return (
    <div className="bg-white w-3/4 h-[90%] flex flex-col text-black rounded-xl mx-auto p-4 overflow-y-scroll transition-all ease-in-out duration-500 relative">
      ...
      <p className="select-none">
        <FlagText text="Hello user," flag={flagged} emailNo={1} index={0} />{" "}
        <br /> <br />
        In order to protect your system account from fraud, we have introduced a
        new security key system <br />
        <br />
        <FlagText text="It&apos;s important you do this urntly" emailNo={1} flag={flagged} index={1} />, As malicious actors could try
        and attack our systems at any minute
        <br />
        <br />
        Please <FlagText text="download this key as an attachment and install the software on
        " emailNo={1} flag={flagged} index={2} /> your computer
        <br />
        <br />
      ...
      <div className="w-1/2 bg-gray-500 text-white p-5 flex flex-row gap-5">
        <h1>📎</h1>
        <h1 className="text-center"> <FlagText text="SecurityKey.exe" emailNo={1} flag={flagged} index={3} /></h1>
      </div>
    </div>
  );
}
